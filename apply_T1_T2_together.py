...
model_save_path = './checkpoint/robust_classifier_T1_T2_seed_5.pth'
...
for epoch in range(start_epoch, start_epoch + args.n_epoch):
    train(epoch, T1_train_all, T2_train_all)
    validation(epoch, T1_val_all, T2_val_all)
...
result_path = './result/train_T1_T2_together_seed_5.txt' 
