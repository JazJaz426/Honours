...
model_save_path = './checkpoint/robust_classifier_T1_T3_seed_5.pth'
...
for epoch in range(start_epoch, start_epoch + args.n_epoch):
    train(epoch, T1_train_all, T3_train_all)
    validation(epoch, T1_val_all, T3_val_all)
...
result_path = './result/train_T1_T3_together_seed_5.txt' 
