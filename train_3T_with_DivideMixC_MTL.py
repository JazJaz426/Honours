...
parser.add_argument('--T_lr', default=3e-4, type=float, help='learning rate for training 3 Ts')
...
MTL_T1_save_path = '/content/drive/MyDrive/final_retrain_21_mar/checkpoint/MTL_T1_Tlr_' + str(args.T_lr) + '.pth'
MTL_T2_save_path = '/content/drive/MyDrive/final_retrain_21_mar/checkpoint/MTL_T2_Tlr_' + str(args.T_lr) + '.pth'
MTL_T3_save_path = '/content/drive/MyDrive/final_retrain_21_mar/checkpoint/MTL_T3_Tlr_' + str(args.T_lr) + '.pth'

num_tasks = 3

# Initialize the SummaryWriter for TensorBoard
writer = SummaryWriter('runs/train_3T_Tlr_' + str(args.T_lr))
...
parameter_dict = [{"params":net_shared.module.parameters(), "lr":0}]
parameter_dict += [{"params":layers_specific[i].module.parameters(), "lr":args.T_lr} for i in range(num_tasks)] 
