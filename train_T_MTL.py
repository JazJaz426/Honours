...
# create three train and val loaders
train_loaders = []
val_loaders = []
noise_types = ['random_label1', 'random_label2', 'random_label3']
...
def train(epoch):
    global task_cov_var
    global class_cov_var
    global feature_cov_var
...
for epoch in range(start_epoch, start_epoch + args.n_epoch):
    # print(f"before task: {task_cov_var}")
    # print(f"before class: {class_cov_var}")
    # print(f"before feature: {feature_cov_var}")
    train(epoch)
    # print(f"after task: {task_cov_var}")
    # print(f"after class: {class_cov_var}")
    # print(f"after feature: {feature_cov_var}")
    validation(epoch)
