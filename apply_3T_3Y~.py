...
model_save_path = './checkpoint/robust_classifier_3T_seed_5.pth'
...
def train(epoch, T1_train_all, T2_train_all, T3_train_all):
    ...
    for batch_idx, (inputs, targets) in enumerate(train_loader):
        ...
        loss_3 = criterion(torch.log(noisy_posterior_reshaped_3), targets_3)
...
result_path = './result/train_3T_together_seed_5_parallel.txt' 
